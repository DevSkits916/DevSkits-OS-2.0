(() => {
  const SYSTEM_DATA = {
    contacts: [
      ...
      { id: 'facebook', label: 'Facebook', value: 'https://www.facebook.com/DevSkits?mibextid=wwXIfr', type: 'url', icon: 'facebook' },
      { id: 'x', label: 'X / Twitter', value: 'https://x.com/DevSkits916', type: 'url', icon: 'x' },
